                    ...
                    <div id="principalInvent">
                        ...
                        <div class="row">
                                ...
                                <div id="divInv" class="col-12 col-lg-12 marginf-ret">
                                    ...
                                    <%
                              		...
                              		<div class="expli-just">
	                                	<p>
	                                		Ingrese los datos descritos a continuación para luego definir la cantidad de accesorios/dispositivos, al terminar presionar "RETIRAR Y GUARDAR".
	                                	</p>
                               		</div>
                                      	...
                                      	%>
											...
											<div class="col col-sm-12 inpform">
												<label for="txtUbicacion" class="form-label">
													Ingrese la ubicación en donde estarán los accesorios/dispositivos
												</label>
												<div class="input-group">
													<span class="input-group-text" id="lblUbicacion">
														<i class="bi bi-building"></i>
													</span>
													<input name="txtUbicacion" id="txtUbicacion" aria-describedby="txtUbicacion" placeholder="Ubicación" class="form-control flexdatalist"
														autocomplete="off" type="text" spellcheck="false" maxlength="100" title="Caracteres de máximo 100 caracteres." required
                                                    ...
                                                    <% 
														try { 
															for (int i = 0; i < cantprod; i++) { 
																...
																out.print("autocomplete='off' type='number' min='0' max='" + productos.get(3) + "' spellcheck='false' maxlength='5' pattern='[0-9]{1,5}' title='Mínimo 1 y máximo 5 dígitos' required");
																out.print("value='0' />");
																out.print("</td>");
																out.print("<td>");
                            ...
                            <div class="row">
                                ...
                                <div class="expli-just">
                                	<p>
                                		Realice la búsqueda y seleccione los accesorios/dispositivos que necesite dándole al check en el cuadro derecho, para luego presionar "AGREGAR A LA LISTA DE RETIROS".
                                	</p>
                                </div>
								<%
   			...
   			<%
				...
				out.print(layout.footer(2));
	   			if(session.getAttribute("succRetP") != null && !session.getAttribute("succRetP").equals("")) {
					out.print(val.mostrarToastr("Éxito", session.getAttribute("succRetP").toString()));
